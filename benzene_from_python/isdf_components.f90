program isdf_components
    ...
    ! This repo
    character(len=79) :: ref_root = "/Users/alexanderbuccheri/Codes/isdf_fortran/benzene_from_python/reference_data/"
    character(len=72) :: fortran_data_root = "/Users/alexanderbuccheri/Codes/isdf_fortran/benzene_from_python/outputs/"
    ...
    ! whereas phi etc wrere constructed in python, so will go array(iz, iy, ix)
